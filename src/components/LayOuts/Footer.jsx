...
const Footer = () => {
  return (
    ...
    //     <p>
    //       Get the latest insights, tips, and updates on revolutionizing your
    ...
    //         className="input input-bordered join-item w-[309px] h-[47px] px-4"
    //       />
    ...
    <div>
      <footer className="footer sm:footer-horizontal text-base-content p-10">
        <nav className="space-y-4 w-[448px]">
          <h4 className="text-2xl font-bold">Subscribe to our Newsletter</h4>
          <p className="text-lg">
            Get the latest insights, tips, and updates on revolutionizing your
            workspace to your inbox.
          ...
          <div className="">
            <input
              type="text"
              placeholder="Your Email"
              className="input input-bordered join-item w-[309px] h-[50px] px-4"
            />
            <button className="btn  bg-indigo-900 text-[15px] text-white px-4 py-6">
              Subscribe
            </button>
          </div>
